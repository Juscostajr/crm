<template>
    ...
    <el-card class="box-card">
        ...
        <cadastrar-perfil :visible.sync="dialogFormVisible" :datamodel="dataModel" @saved="findAll"></cadastrar-perfil>
...
export default {
  ...
  methods: {
    ...
    find() {
      this.$request.get(`perfil/${this.search}`).then(response => {
        this.tableData = response.data;
      });
    },
    handleDelete(row) {
