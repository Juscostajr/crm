<template>
    ...
    <el-card class="box-card">
        ...
        <cadastrar-operadora :visible.sync="dialogFormVisible" :datamodel="dataModel" @saved="findAll"/>
...
export default {
  ...
  methods: {
    ...
    find() {
      this.$request.get(`operadora/${this.search}`).then(response => {
        this.tableData = response.data;
      });
    },
    handleDelete(row) {
