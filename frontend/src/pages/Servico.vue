<template>
    <el-card class="box-card">
        ...
        <cadastrar-servico :visible.sync="dialogFormVisible" :datamodel="dataModel" @saved="findAll"></cadastrar-servico>
...
export default {
  ...
  methods: {
    ...
    find() {
      this.$request.get(`servico/${this.search}`).then(response => {
        this.tableData = response.data;
      });
    },
    handleDelete(row) {
