 ...
 */
class TabelaPreco extends \App\Entity\TabelaPreco implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\TabelaPreco' . "\0" . 'id', '' . "\0" . 'App\\Entity\\TabelaPreco' . "\0" . 'descricao', '' . "\0" . 'App\\Entity\\TabelaPreco' . "\0" . 'valor'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TabelaPreco $proxy) {
