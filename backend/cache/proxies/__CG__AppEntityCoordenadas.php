 ...
 */
class Coordenadas extends \App\Entity\Coordenadas implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Coordenadas' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Coordenadas' . "\0" . 'latitude', '' . "\0" . 'App\\Entity\\Coordenadas' . "\0" . 'longitude'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Coordenadas $proxy) {
