 ...
 */
class Grupo extends \App\Entity\Grupo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Grupo' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Grupo' . "\0" . 'tipo', '' . "\0" . 'App\\Entity\\Grupo' . "\0" . 'descricao', '' . "\0" . 'App\\Entity\\Grupo' . "\0" . 'membros'];
        }
     ...
     * {@inheritDoc}
     */
    public function getTipo(): \App\Entity\TipoGrupo
    {
     ...
     * {@inheritDoc}
     */
    public function setTipo(\App\Entity\TipoGrupo $tipo)
    {
     ...
     * {@inheritDoc}
     */
    public function addMembro(\App\Entity\Pessoa $membro)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addMembro', [$membro]);

        return parent::addMembro($membro);
    }
