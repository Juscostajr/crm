 ...
 */
class Servico extends \App\Entity\Servico implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Servico' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Servico' . "\0" . 'descricao', '' . "\0" . 'App\\Entity\\Servico' . "\0" . 'adesoes'];
        }
