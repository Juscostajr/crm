 ...
 */
class FeedBack extends \App\Entity\FeedBack implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\FeedBack' . "\0" . 'id', '' . "\0" . 'App\\Entity\\FeedBack' . "\0" . 'justificativa', '' . "\0" . 'App\\Entity\\FeedBack' . "\0" . 'data', '' . "\0" . 'App\\Entity\\FeedBack' . "\0" . 'indicador', '' . "\0" . 'App\\Entity\\FeedBack' . "\0" . 'hora', '' . "\0" . 'App\\Entity\\FeedBack' . "\0" . 'observacao'];
        }
    ...
    public function getJustificativa(): string
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getJustificativa', []);
    ...
    public function setJustificativa(string $justificativa)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setJustificativa', [$justificativa]);
