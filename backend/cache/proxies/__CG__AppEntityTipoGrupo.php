 ...
 */
class TipoGrupo extends \App\Entity\TipoGrupo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\TipoGrupo' . "\0" . 'id', '' . "\0" . 'App\\Entity\\TipoGrupo' . "\0" . 'descricao'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TipoGrupo $proxy) {
